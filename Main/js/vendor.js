...
var ViewModel = function() {
  ...
  */
  this.msgToUser = ko.observable('Find Beer Anywhere');
  ...
  */
  this.currentAddress = ko.observable("241 Rockingham Drive, GA");
  ...
  */
  this.findNearByWithFoursquare = function(lat, lng, callback) {
    ...
    self.msgToUser('Looking for bars nearby...');
    ...
    $.getJSON(requestURL, function(data) {
      ...
      if (foursquareNearByPlaces.length > 0) {
        self.msgToUser('We found ' + self.numOfNearByPlaces() + ' bars nearby!');
        ...
        // handle no results
        self.msgToUser('No bars here. Try another location');
      }
  ...
  */
  ...
  mapOptions = {
    zoom: 9,
    center: latlng(33.863921, -83.937144),
